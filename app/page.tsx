...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-col space-y-16 sm:space-y-24 pb-16">
      {/* Hero Section */}
      <section className="relative pt-24 lg:pt-32 pb-20 overflow-hidden bg-navy-950 min-h-[90vh] flex flex-col justify-center">
        {/* Subtle Pattern Background */}
        <div className="absolute inset-0 bg-grid-slate-900/[0.04] bg-[size:32px_32px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left space-y-8 max-w-2xl">
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/60 border border-slate-700/50 text-xs font-semibold text-slate-300 shadow-sm"
            >
              <Scale className="w-3.5 h-3.5 text-gold-400" />
              <span>India's Premium AI Legal Assistant</span>
            </motion.div>
            ...
            <motion.div 
              ...
              className="space-y-6"
            >
              <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-bold text-white tracking-tight leading-[1.1]">
            ...
            <motion.form
              ...
              className="relative flex flex-col sm:flex-row items-center p-1.5 rounded-xl bg-white/5 border border-white/10 shadow-lg focus-within:border-gold-500/50 focus-within:bg-white/10 transition-all gap-2 backdrop-blur-sm max-w-xl"
            >
              <input
                type="text"
                value={quickInput}
                ...
                className="w-full px-4 py-3.5 bg-transparent text-sm text-white placeholder-slate-400 outline-none"
              />
              <button
                type="submit"
                className="w-full sm:w-auto px-6 py-3.5 rounded-lg bg-gold-500 hover:bg-gold-400 text-navy-950 font-bold text-sm flex items-center justify-center gap-2 transition-colors shrink-0"
              >
                <span>Ask Nyay Mitra</span>
            ...
            <motion.div 
              ...
              className="pt-4 flex flex-wrap items-center gap-6 text-xs text-slate-400 font-medium"
            >
          ...
          >
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-br from-gold-500/20 to-blue-500/10 rounded-2xl blur-2xl"></div>
            
            <div className="relative bg-slate-900/90 border border-slate-800 rounded-2xl shadow-2xl p-6 backdrop-blur-md overflow-hidden flex flex-col space-y-6">
              {/* Fake Mac Window header */}
              <div className="flex items-center gap-2 pb-4 border-b border-slate-800/80">
                <div className="w-3 h-3 rounded-full bg-slate-700"></div>
                <div className="w-3 h-3 rounded-full bg-slate-700"></div>
                <div className="w-3 h-3 rounded-full bg-slate-700"></div>
                <span className="ml-2 text-[10px] text-slate-500 font-mono tracking-widest uppercase">Analysis Complete</span>
              </div>
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  <div className="flex items-center gap-2 text-gold-400 font-semibold text-xs tracking-wider uppercase">
                    ...
                    <span>Legal Domain Identified</span>
                  </div>
                  <div className="inline-block px-2.5 py-1 rounded bg-slate-800 border border-slate-700 text-slate-200 text-xs">
                    Tenant Rights & Security Deposit Dispute
                  </div>
                </div>
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex items-center gap-2 text-emerald-400 font-semibold text-xs tracking-wider uppercase">
                    ...
                    <span>Relevant Indian Laws</span>
                  </div>
                  <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700/50 space-y-1">
                    <div className="flex items-center justify-between text-xs">
                      <span className="font-bold text-slate-200">Transfer of Property Act, 1882</span>
                      <span className="font-mono px-1.5 py-0.5 rounded bg-slate-900 text-gold-300 text-[10px] border border-gold-500/20">Section 108</span>
                    </div>
                    <p className="text-[11px] text-slate-400 leading-relaxed">
                      Governs the rights and liabilities of lessor and lessee. Without documented damages, withholding deposit is unlawful.
                    </p>
                  </div>
                </div>

                <div className="pt-4 border-t border-slate-800 flex items-center justify-between">
                  <span className="text-[11px] text-slate-500">Processing time: 1.2s</span>
                  <div className="flex items-center gap-1.5 text-[11px] font-medium text-gold-400 bg-gold-500/10 px-2 py-1 rounded">
                    <FileText className="w-3 h-3" />
                    Notice Prefill Ready
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="glass-card p-8 rounded-2xl flex flex-col gap-4 text-center items-center group cursor-pointer"
            >
              <div className="w-14 h-14 rounded-full bg-gold-500/10 flex items-center justify-center text-gold-400 group-hover:scale-110 group-hover:bg-gold-500/20 transition-all duration-300 shadow-gold-glow">
                <feature.icon className="w-7 h-7" />
              </div>
              <h3 className="font-bold text-white text-lg group-hover:text-gold-300 transition-colors">{feature.title}</h3>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 sm:p-12 rounded-3xl bg-slate-900/60 border border-slate-800 relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800">
                  <div className="font-bold text-rose-400 text-sm mb-1">Traditional Barrier</div>
                  <div className="text-xs text-slate-400 leading-relaxed">
                    Advocate fees starting at ₹5,000 just for initial drafting, with zero transparency on outcome probability.
                  </div>
                </div>
                <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800">
                  <div className="font-bold text-emerald-400 text-sm mb-1">The Nyay Mitra Solution</div>
                  <div className="text-xs text-slate-400 leading-relaxed">
            ...
            <div className="lg:col-span-5 flex flex-col justify-center space-y-4 p-6 rounded-2xl bg-slate-950 border border-slate-800">
              <h3 className="font-bold text-sm text-gold-400 uppercase tracking-wider">
                Key Civic Impact Metrics
              </h3>
              <div className="space-y-4">
                <div className="border-b border-slate-800 pb-3">
                  <div className="text-2xl font-extrabold text-white">85%</div>
                  <div className="text-xs text-slate-400">of tenancy and consumer disputes settle upon receiving a formal legal notice.</div>
                </div>
                <div className="border-b border-slate-800 pb-3">
                  <div className="text-2xl font-extrabold text-white">15 Days</div>
                  <div className="text-xs text-slate-400">Statutory standard compliance window to resolve grievances before filing cases.</div>
                </div>
                <div>
                  <div className="text-2xl font-extrabold text-white">0 Hallucinations</div>
                  <div className="text-xs text-slate-400">Statute-anchored framework verified against actual Indian central & state enactments.</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="relative p-6 rounded-2xl bg-slate-900 border border-slate-800 hover:border-gold-500/50 transition-colors group">
              <div className="absolute -top-4 -right-4 text-7xl font-bold text-slate-800/30 group-hover:text-gold-500/10 transition-colors pointer-events-none select-none">
                {item.step}
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            <div 
              ...
              className="p-5 rounded-xl bg-slate-900/50 border border-slate-800 hover:border-gold-500/40 hover:bg-slate-900 transition-all cursor-pointer group"
            >
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-bold text-white text-sm group-hover:text-gold-300 transition-colors">
                  {scenario.title}
                </h3>
                <ArrowRight className="w-4 h-4 text-slate-600 group-hover:text-gold-400 transition-colors" />
              </div>
